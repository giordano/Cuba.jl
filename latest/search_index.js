...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "Cuba.jl is available for Julia 0.7 and later versions, and can be installed with Julia built-in package manager. In a Julia session run the commandsjulia> using Pkg\njulia> Pkg.update()\njulia> Pkg.add(\"Cuba\")Older versions are also available for Julia 0.4-0.6."
},
...

{
    ...
    "category": "section",
    "text": "Another Julia package for multidimenensional numerical integration is available: Cubature.jl, by Steven G. Johnson."
},
